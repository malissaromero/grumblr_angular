  ...
  app.controller('grumblesController', function() {
    this.grumbles = [{
      comments: [{ id: 0, content: "I'm a comment #1!" }],
        "id":667,
        "authorName":"Jesse",
        "content":"Only those who attempt the impossible can achieve the absurd.","title":"29 hipster kanye quotes that people born after 1990 wil never understand",
    ...
    this.create = function(grumble){
      ...
      grumble.comments.unshift({
        author: grumble.newCommentAuthor
        content: grumble.newCommentContent
      });
      grumble.newCommentContent = "";
    };

    this.updateComment = function(grumble){
      this.newcomment[grumble] = {
                      author: this.updatedAuthor,
                      content: this.updatedContent
                    }
    };

    this.currentComment = function(grumble){
      this.updatedAuthor = this.newComment[grumble].author;
      this.updatedContent = this.comment[grumble.content];
    }
  })
